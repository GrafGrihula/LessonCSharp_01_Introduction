...
namespace FileManager
{
    class FileManager
    {
        ...
        public FileManager()
        {
            ...
            filePanel.Top = 0;
            filePanel.Left = FilePanel.PANEL_WIDTH/2;
            this.panels.Add(filePanel);
        ...
        {
            InfoHelp infoHelp = new InfoHelp();
        ...
        private void BackPanel()
        {
            ...
            {
                //this.panels[ this.activePanelIndex ].SetDiscs(); // Почему-то иногда выдаёт ошибку, когда жмёшь бэкспейс на панели с дисками
                this.panels[ this.activePanelIndex ].UpdatePanel();
            }
        }
        ...
        private void ViewFile()
        {
            ...
            Encoding.RegisterProvider( CodePagesEncodingProvider.Instance ); // Это помогло "читать" текст, написанный русскими буквами (в кодировке 1251). Но как это работает???
            string fileContent = this.ReadFileToString(fileObject.FullName, Encoding.GetEncoding( 1251 ) );
        ...
        {
            string[] menu = { "F1 Помощь", "F2 Задачи", "F3 Просмотр", " F4 Поиск", "F5 Копия", "F6 Перемещ", "F7 Создать", "F8 Переимен", "F9 Удаление", "F10 Выход" };
