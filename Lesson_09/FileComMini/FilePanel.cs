...
namespace FileManager
{
    class FilePanel
    {
        ...
        public static int PANEL_WIDTH = 140;
        ...
        public int Left
        {
            ...
            set
            {
                if (0 <= value && value <= Console.WindowWidth - FilePanel.PANEL_WIDTH/2)
                {
                    this.left = value;
                }
                else
        ...
        private int height = FilePanel.PANEL_HEIGHT*2;
        public int Height
        {
            get
            {
        ...
        private int width = FilePanel.PANEL_WIDTH/2; //  Располовинил панели
        public int Width
        {
            get
            {
        ...
        private int displayedObjectsAmount = PANEL_HEIGHT*2 - 2; // Высота листинга
        private bool active;
        public bool Active
        {
            get
